    ...
    <div class="container mx-auto px-4 py-3">
        <div class="bg-white shadow-lg rounded-lg p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
                ...
                <p class="text-green-600 text-xl font-semibold mb-4">$<?= $price ?></p>
                <div class="mb-6">
                    ...
                    <table class="w-full text-center text-sm border border-gray-300 rounded overflow-hidden">
                        ...
                        <tr>
                            <th class="px-2 py-1 border border-gray-300">36</th>
                            <th class="px-2 py-1 border border-gray-300">37</th>
                            <th class="px-2 py-1 border border-gray-300">38</th>
                            <th class="px-2 py-1 border border-gray-300">39</th>
                            <th class="px-2 py-1 border border-gray-300">40</th>
                            <th class="px-2 py-1 border border-gray-300">41</th>
                            <th class="px-2 py-1 border border-gray-300">42</th>
                            <th class="px-2 py-1 border border-gray-300">43</th>
                            <th class="px-2 py-1 border border-gray-300">44</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
        ...
        <div class="bg-white shadow-md rounded-lg p-6 mt-10">
            ...
            <form method="POST" class="space-y-4">
                ...
                <div class="flex items-center mt-2 space-x-1">
                    <?php for ($i = 1; $i <= 5; $i++): ?>
                    <i class="fa-regular fa-star text-2xl text-yellow-400 cursor-pointer" data-value="<?= $i ?>"></i>
                    <?php endfor; ?>
                </div>
